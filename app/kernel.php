...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \Fruitcake\Cors\HandleCors::class, // Ensure fruitcake/cors is installed
    ...
    protected $routeMiddleware = [
        ...
        // Custom Middleware
        'role' => \App\Http\Middleware\CheckRole::class, // Add this if you've created CheckRole middleware
    ];
}
